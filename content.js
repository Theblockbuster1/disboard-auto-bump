...
Once you have opened the popup, please press 'OK'.`,
    ...
    $(document).on("click", "#pick", function () {
        ...
        defineTabID($(`#transferring ~ [href^="/server/bump/"]`).attr("href").replace(/\/server\/bump\//g, ''));
    ...
    $("[href='/server/bump/" + ID + "'] span i:last-of-type").attr("class", "icon-robot");
    $("[href='/server/bump/" + ID + "']").attr("id", "bumpme");
    $("[href='/server/bump/" + ID + "']").removeAttr("disabled");

...
setTimeout(function(){ // allows the bump button to load it's timer text (00:00:00) before checking if it should be bumped - a temporary and unreliable fix to the captcha popup problem but it works ¯\_(ツ)_/¯
    ...
    $(`[href]:not(.languages > li > a):not([href^="${lang}/server/bump/"])`).attr("target", "_blank");
    ...
    $("div.navbar-right").prepend(`<a class="navbar-item" id="bump" title="Made by Theblockbuster1!" style="width: 20.125rem; margin-right: 10px;">
    ...
    $("div.servers.columns div.buttons").prepend(`<a class="button is-dark" id="pick">
